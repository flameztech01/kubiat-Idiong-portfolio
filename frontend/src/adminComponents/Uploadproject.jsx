...
import { useUploadProjectsMutation } from '../slices/adminApiSlice'
import { toast } from 'react-toastify'

const Uploadproject = () => {
    const [uploadProject, { isLoading }] = useUploadProjectsMutation()
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await uploadProject(submitData).unwrap()
            ...
            toast.error(error?.data?.message || 'Failed to upload project')
        }
    }
    ...
    return (
        <div className="flex min-h-screen bg-gray-50">
            ...
            <main className="flex-1 ml-0 lg:ml-64 p-6 lg:p-8 overflow-auto">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">Upload New Project</h1>
                    <p className="text-gray-600 mt-2">Add your completed projects to showcase in your portfolio</p>
                </div>
                ...
                <div className="max-w-4xl">
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-200">
                        <div className="p-6 border-b border-gray-200">
                            ...
                            <p className="text-gray-600 text-sm mt-1">Fill in the details of your project</p>
                        </div>
